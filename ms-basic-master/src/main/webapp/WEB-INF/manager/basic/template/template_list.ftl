<@ms.html5>
	...
	<@ms.panel>
		<@shiro.hasPermission name="template:upload"><@ms.uploadFile path="templets/${websiteId}/" uploadFloderPath="true" inputName="websiteStyle" size="10" filetype="zip" msg="建议上传30M以下的zip文件,模版名称不能使用中文,zip的压缩方式为:存储"  maxSize="30" callBack="setUrl" isRename="false"/></@shiro.hasPermission>
	...
	<script type="text/javascript">
       ...
       function setUrl(e){
       		fileUrl = e;
           	 $.ajax({
				   ...
				   success: function(msg){ 
				     	...
				     	location.href="${managerPath}/template/queryTemplateSkin.do"
				   }
			  });            	   
	   	} 
		...
		$("#deleteButton").click(function(){
			var URL = "${managerPath}/template/delete.do";

...
function editContentModelField(fieldId){
		var URL = "${managerPath}/mdiy/contentModel/contentModelField/"+fieldId+"/edit.do";
	...
	$("#addContentModelFieldBtn").click(function(){
		$("input[name='fieldFieldName']").removeAttr("readonly");
...
function editContentModel(cmId){
	location.href= "${managerPath}/mdiy/contentModel/"+cmId+"/edit.do";
}
</script>

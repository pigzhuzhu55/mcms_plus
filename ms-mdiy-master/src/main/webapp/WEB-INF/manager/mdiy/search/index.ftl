...
<script>
	$(function(){
		//加载选择模块列表
		$("#searchTemplets").request({url:"${managerPath}/template/queryTemplateFileForColumn.do",type:"json",method:"get",func:function(msg) {
	...
	function updateSearch(searchId){
		$(this).request({url:"${managerPath}/mdiy/search/form.do?searchId="+searchId,method:"get",func:function(search) {
